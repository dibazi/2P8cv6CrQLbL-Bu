<template>
    <div class="todolistContainer">
        <div class="heading">
            ...
            <h2 id="title">Opportunites par des particulier, click <inertia-link  class="senga" href="/p/o">ici.</inertia-link></h2>
    ...
    export default {
        ...
        methods: {
            ...
            search: _.throttle(function(){
                this.$inertia.replace(this.route('companies',{term:this.term}))
            }, 200),
