                                    ...
                                    <div class="bg-white rounded-xl shawdow-lg p-8 text-gray-600">
                                        ...
                                        <form @submit.prevent="updateCheck()" action="" class="flex flex-col space-y-4 contact-form">
                                            ...
                                            <div>
                                                ...
                                                <input name="job.companyName" id="job.companyName" v-model="job.companyName" required type="text"  placeholder="Nom de la companie. Exp Kaji Limited"  class="ring ring-gray-300 text-green-500 w-full rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-teal-300 form-control is-invalid" >
                                            ...
                                            <div>
                                                ...
                                                <input name="job.country" id="job.country" v-model="job.country" required  type="text" placeholder="Pays dans lequel la companie est etablie. Exp. RD Congo" class="ring ring-gray-300 text-green-500 w-full rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-teal-300">
                                            ...
                                            <div>
                                                ...
                                                <input name="job.province" id="job.province" v-model="job.province" type="text" placeholder="Province/Region ou le post est disponible" required class="ring ring-gray-300 text-green-500 w-full rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-teal-300">
                                            ...
                                            <div>
                                                ...
                                                <input name="job.city" id="job.city" v-model="job.city" required  type="text" placeholder="Ville dans laquel la companie est etablie. Exp. Lubumbashi" class="ring ring-gray-300 text-green-500 w-full rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-teal-300">
                                             ...
                                             <div>
                                                ...
                                                <input name="job.adress" id="job.adress" v-model="job.adress" required  type="text" placeholder="Adress de la companie" class="ring ring-gray-300 text-green-500 w-full rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-teal-300">
                                             ...
                                             <div>
                                                ...
                                                <input name="job.companyTel" id="job.companyTel" v-model="job.companyTel" required  type="text" placeholder="Numeraux telephone de la companie Exp. 0112346756" class="ring ring-gray-300 text-green-500 w-full rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-teal-300">
                                            ...
                                            <div><label for="" class="text-blue-700">Information sur le poste</label></div>
                                             ...
                                             <div>
                                                ...
                                                <input name="job.domaine" id="job.domaine" v-model="job.domaine" required  type="text" placeholder="Ex. construction" class="ring ring-gray-300 text-green-500 w-full rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-teal-300">
                                             ...
                                             <div>
                                                ...
                                                <input name="job.position" id="job.position" v-model="job.position" required  type="text" placeholder="Ex. Chef de chantier" class="ring ring-gray-300 text-green-500 w-full rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-teal-300">
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <select name="job.currency" id="job.currency" v-model="job.currency" required class="ring ring-gray-300 text-green-500 outline-none focus:ring-teal-300 block mt-1 w-full px-4 py-2 border-gray-300 rounded-md shadow-sm">
                                            ...
                                            <div>
                                                ...
                                                <input name="job.salary" id="job.salary" v-model="job.salary" required type="text" placeholder="Salaire du post Exp. 200000" class="ring ring-gray-300 text-green-500 w-full rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-teal-300">
                                            ...
                                            <div>
                                                ...
                                                <textarea name="job.description" id="job.description" v-model="job.description" required  rows="10" class="ring ring-gray-300 text-green-500 w-full rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-teal-300" placeholder="Description du post, responsabilite..."></textarea>
                                            ...
                                            <div>
                                                ...
                                                <datepicker lang="fr" format="YYYY-MM-dd" name="job.dateFinal" id="job.dateFinal" v-model="job.dateFinal" required  type="text" placeholder="Date final depot de candidature Exp. 21/02/2021" class="ring ring-gray-300 text-green-500 w-full rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-teal-300" />                                                <div v-if="hasErrors('job.dateFinal')">
                                            ...
                                            <div>
                                                ...
                                                <input name="job.cvemail" id="job.cvemail" v-model="job.cvemail" required  type="email" placeholder="Adress mail ou envoyer les cv Exp. adressecv@kaji.com" class="ring ring-gray-300 text-green-500 w-full rounded-md px-4 py-2 outline-none focus:ring-2 focus:ring-teal-300">
                                                <div v-if="hasErrors('job.cvemail')">
                                                    <p class="text-red-700">Adress mail ou envoyer les cv.</p> 
                                                </div>
                                            </div>

                                            <button class="inline-block self-end bg-green-500 text-white font rounded-lg px-6 py-2 uppercase ">Modifier</button>
                                            <div v-if="success">
